...
G-code (final.nc) — не продукт, а промежуточный артефакт производства; продукт — изготовленный ложемент.
...
Сразу после создания заказа должна быть точка интеграции “оплата → confirmed → производство → produced”
